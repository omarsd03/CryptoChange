<aside class="col-md-3 hidden-xs hidden-sm">
    ...
    <div class="list-group">
        <a href="#" class="list-group-item">Elecciones 2018</a>
        <a href="#" class="list-group-item">Socavon Cuernavaca</a>
        <a href="#" class="list-group-item">Cuernavaca Sin Agua</a>
        <a href="#" class="list-group-item">Desvio de Recursos</a>
        <a href="#" class="list-group-item">Graco Ramirez</a>
    </div>

    <h4>Licitaciones Destacadas</h4>
